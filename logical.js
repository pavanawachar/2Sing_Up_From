...
// Function to update error messages (email)
...
// Function to update error messages (passaward)
function updateErrorMessage_password (input, errorElement, successElement, isValid) {
    if (!isValid) {
...
function handleSubmit(event) {
    ...
    updateErrorMessage_password(password, passwordError, passwordSuccess, isPasswordValid);
...
passwordInput.addEventListener('input', function() {
    ...
    updateErrorMessage_password(password, passwordError, passwordSuccess, isValid);
});
